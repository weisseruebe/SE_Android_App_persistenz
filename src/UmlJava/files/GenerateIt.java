 ...
 * @generated
 */
public class GenerateIt extends AbstractAcceleoGenerator {
	/**
	 ...
	 * @generated
	 */
	public GenerateIt(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public GenerateIt(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
    ...
    try {
      if (args.length < 2) {
        ...
        GenerateIt generator = new GenerateIt(modelURI, folder, arguments);
	...
	public void registerResourceFactories(ResourceSet resourceSet) {
		...
		URI uri = URI.createURI("jar:file:/Applications/eclipse3.6/plugins/org.eclipse.uml2.uml.resources_3.1.1.v201008191505.jar!/"); // for example
